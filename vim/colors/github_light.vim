...
highlight Pmenu guifg=#1F2328 guibg=#eaeef2 ctermfg=235 ctermbg=255 gui=NONE cterm=NONE
...
highlight StatusLine guifg=#ffffff guibg=#4a7fc2 ctermfg=231 ctermbg=67 gui=NONE cterm=NONE
highlight StatusLineNC guifg=#424a53 guibg=#eaeef2 ctermfg=239 ctermbg=255 gui=NONE cterm=NONE
highlight TabLine guifg=#24292f guibg=#eeeff0 ctermfg=235 ctermbg=255 gui=NONE cterm=NONE
highlight TabLineFill guifg=NONE guibg=#eaeef2 ctermfg=NONE ctermbg=255 gui=NONE cterm=NONE
