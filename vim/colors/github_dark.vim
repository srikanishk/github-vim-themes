...
highlight Normal guifg=#e6edf3 guibg=#21262d ctermfg=255 ctermbg=235 gui=NONE cterm=NONE
highlight NormalNC guifg=#e6edf3 guibg=#21262d ctermfg=255 ctermbg=235 gui=NONE cterm=NONE
highlight ColorColumn guifg=NONE guibg=#252a31 ctermfg=NONE ctermbg=235 gui=NONE cterm=NONE
highlight Conceal guifg=#6e7681 guibg=NONE ctermfg=243 ctermbg=NONE gui=NONE cterm=NONE
highlight Cursor guifg=#21262d guibg=#e6edf3 ctermfg=235 ctermbg=255 gui=NONE cterm=NONE
...
highlight DiffAdd guifg=NONE guibg=#233830 ctermfg=NONE ctermbg=236 gui=NONE cterm=NONE
highlight DiffChange guifg=NONE guibg=#2a4e80 ctermfg=NONE ctermbg=24 gui=NONE cterm=NONE
highlight DiffDelete guifg=NONE guibg=#372a30 ctermfg=NONE ctermbg=236 gui=NONE cterm=NONE
highlight DiffText guifg=NONE guibg=#484f58 ctermfg=NONE ctermbg=239 gui=NONE cterm=NONE
highlight EndOfBuffer guifg=#21262d guibg=NONE ctermfg=235 ctermbg=NONE gui=NONE cterm=NONE
...
highlight Folded guifg=#484f58 guibg=#252a31 ctermfg=239 ctermbg=235 gui=NONE cterm=NONE
highlight FoldColumn guifg=#484f58 guibg=NONE ctermfg=239 ctermbg=NONE gui=NONE cterm=NONE
highlight SignColumn guifg=#484f58 guibg=#21262d ctermfg=239 ctermbg=235 gui=NONE cterm=NONE
highlight Substitute guifg=#21262d guibg=#da3633 ctermfg=235 ctermbg=167 gui=NONE cterm=NONE
highlight LineNr guifg=#484f58 guibg=NONE ctermfg=239 ctermbg=NONE gui=NONE cterm=NONE
highlight CursorLineNr guifg=#e6edf3 guibg=NONE ctermfg=255 ctermbg=NONE gui=NONE cterm=NONE
highlight MatchParen guifg=#e6edf3 guibg=#294a78 ctermfg=255 ctermbg=24 gui=bold cterm=bold
...
highlight Pmenu guifg=#e6edf3 guibg=#191e25 ctermfg=255 ctermbg=234 gui=NONE cterm=NONE
highlight PmenuSel guifg=#e6edf3 guibg=#294a78 ctermfg=255 ctermbg=24 gui=NONE cterm=NONE
highlight! link PmenuSbar Pmenu
highlight PmenuThumb guifg=NONE guibg=#28446b ctermfg=NONE ctermbg=238 gui=NONE cterm=NONE
highlight Search guifg=#e6edf3 guibg=#4b4737 ctermfg=255 ctermbg=238 gui=NONE cterm=NONE
highlight IncSearch guifg=#0d1117 guibg=#db6d28 ctermfg=233 ctermbg=166 gui=NONE cterm=NONE
...
highlight StatusLine guifg=#21262d guibg=#2f6abc ctermfg=235 ctermbg=25 gui=NONE cterm=NONE
highlight StatusLineNC guifg=#484f58 guibg=#191e25 ctermfg=239 ctermbg=234 gui=NONE cterm=NONE
highlight TabLine guifg=#7d8590 guibg=#252a31 ctermfg=102 ctermbg=235 gui=NONE cterm=NONE
highlight TabLineFill guifg=NONE guibg=#191e25 ctermfg=NONE ctermbg=234 gui=NONE cterm=NONE
highlight TabLineSel guifg=#21262d guibg=#484f58 ctermfg=235 ctermbg=239 gui=NONE cterm=NONE
highlight Title guifg=#79c0ff guibg=NONE ctermfg=111 ctermbg=NONE gui=bold cterm=bold
highlight Visual guifg=NONE guibg=#28446b ctermfg=NONE ctermbg=238 gui=NONE cterm=NONE
...
highlight Identifier guifg=#e6edf3 guibg=NONE ctermfg=255 ctermbg=NONE gui=NONE cterm=NONE
...
highlight Type guifg=#ffa657 guibg=NONE ctermfg=215 ctermbg=NONE gui=NONE cterm=NONE
highlight! link StorageClass Type
highlight! link Structure Type
highlight! link Typedef Type
highlight Special guifg=#e6edf3 guibg=NONE ctermfg=255 ctermbg=NONE gui=NONE cterm=NONE
...
highlight Todo guifg=#21262d guibg=#388bfd ctermfg=235 ctermbg=69 gui=NONE cterm=NONE

highlight Added guifg=#2ea043 guibg=#233830 ctermfg=35 ctermbg=236 gui=NONE cterm=NONE
highlight Changed guifg=#bb8009 guibg=#2a4e80 ctermfg=136 ctermbg=24 gui=NONE cterm=NONE
highlight Removed guifg=#da3633 guibg=#372a30 ctermfg=167 ctermbg=236 gui=NONE cterm=NONE
...
highlight diffNewFile guifg=#7d8590 guibg=NONE ctermfg=102 ctermbg=NONE gui=NONE cterm=NONE
...
highlight DiagnosticHint guifg=#7d8590 guibg=NONE ctermfg=102 ctermbg=NONE gui=NONE cterm=NONE
...
highlight CocHintSign guifg=#7d8590 guibg=NONE ctermfg=102 ctermbg=NONE gui=NONE cterm=NONE
highlight GitGutterAdd guifg=#2ea043 guibg=NONE ctermfg=35 ctermbg=NONE gui=NONE cterm=NONE
...
highlight htmlTag guifg=#7ee787 guibg=NONE ctermfg=114 ctermbg=NONE gui=NONE cterm=NONE
highlight! link xmlAttrib htmlTag
highlight! link xmlTagName htmlTag
highlight cssBraces guifg=#e6edf3 guibg=NONE ctermfg=255 ctermbg=NONE gui=NONE cterm=NONE
...
highlight yamlBlockMappingKey guifg=#7ee787 guibg=NONE ctermfg=114 ctermbg=NONE gui=NONE cterm=NONE
highlight yamlFlowMappingKey guifg=#7ee787 guibg=NONE ctermfg=114 ctermbg=NONE gui=NONE cterm=NONE

let g:terminal_ansi_colors = ['#484f58', '#ff7b72', '#3fb950', '#d29922', '#58a6ff', '#bc8cff', '#39c5cf', '#b1bac4', '#6e7681', '#ffa198', '#56d364', '#e3b341', '#79c0ff', '#d2a8ff', '#56d4dd', '#ffffff']
