...
" Source theme: github_light_tritanopia
set background=light
highlight clear
if exists('syntax_on')
  syntax reset
endif
let g:colors_name = 'github_light_tritanopia'
...
highlight DiffDelete guifg=NONE guibg=#fff5f4 ctermfg=NONE ctermbg=231 gui=NONE cterm=NONE
...
highlight IncSearch guifg=#ffffff guibg=#a40e26 ctermfg=231 ctermbg=124 gui=NONE cterm=NONE
...
highlight Type guifg=#a40e26 guibg=NONE ctermfg=124 ctermbg=NONE gui=NONE cterm=NONE
...
highlight Removed guifg=#d1242f guibg=#fff5f4 ctermfg=160 ctermbg=231 gui=NONE cterm=NONE
...
let g:terminal_ansi_colors = ['#24292f', '#cf222e', '#0550ae', '#4d2d00', '#0969da', '#8250df', '#1b7c83', '#6e7781', '#57606a', '#a40e26', '#0969da', '#633c01', '#218bff', '#a475f9', '#3192aa', '#8c959f']
